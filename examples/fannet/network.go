...
func Network() *glow.Network {
	...
	err = n.AddLink(node0, node4, size)
	if err != nil {
		panic(err)
	}
	...
	err = n.AddLink(node3, node4, size)
	if err != nil {
		panic(err)
	}

	err = n.AddLink(node4, node5, size)
	if err != nil {
		panic(err)
	}

	err = n.AddLink(node4, node6, size)
	if err != nil {
		panic(err)
	}

	err = n.AddLink(node4, node7, size)
	if err != nil {
		panic(err)
	}
